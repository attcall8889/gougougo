...
// @updateTime: 2021-04-23 16:13:38
// ==/UserScript==
(function() {
	/*
	 * 自定义区域
	...
	// 解析接口（可多个）
	const parseInterfaces =["https://jx.xiaolangyun.com/?url=","https://jx.ergan.top/?url=","https://z1.m1907.cn?eps=0&jx=","https://jx.yunboys.cn/?url=","http://17kyun.com/api.php?url=" ];
	/*
	 * 非自定义区域
	 * 以下代码勿动
	 * 以下代码勿动
	 ...
	 */
	// 视频网站(规则已定，不可随意更改)
	const videoSites = ["v.qq.com","tv.sohu.com","iqiyi.com","youku.com","mgtv.com","m.le.com","www.le.com","1905.com","pptv.com","bilibili.com","utao520.22web.org"];
    ...
    // 视频播放框类ID
	var classAndIDMap	= {"pc":{"v.qq.com":"mod_player","iqiyi.com":"flashbox","youku.com":"ykPlayer","mgtv.com":"mgtv-player-wrap","sohu.com":"x-player","le.com":"fla_box","1905.com":"player","pptv.com":"pplive-player","bilibili.com":"bilibili-player-video-wrap|player-limit-mask","utao520.22web.org":"play-box|playBoxIframe","www.iqiyi.com":"qy-player-absolute|realFlashboxr"},"mobile":{"v.qq.com":"mod_player","iqiyi.com":"m-box","youku.com":"h5-detail-player","mgtv.com":"video-area","sohu.com":"player-view","le.com":"playB","1905.com":"player","pptv.com":"pp-details-video","bilibili.com":"bilibiliPlayer|player-wrapper","utao520.22web.org":"play-box|playBoxIframe"}};
    // 创建图标
    createIcon();
	// 判断页面加载完成以后图标是否存在
